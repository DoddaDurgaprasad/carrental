...
const Testimonial = () => {
    ...
    const testimonials = [
        {  name: "Emma Rodriguez", 
            ...
            rating: 5,
            testimonial: "I've rented cars from various companies, but the experience with CaeRental was exceptional"
        },
        {  name: "Liam Johnson",
           location: "New York, USA",
           image: assets.testimonial_image_2,
           rating: 4,
           testimonial: "CarRental mase my trip so much easier, The car was delivered right to my door, and the customer service was fantastic!"
        },
        {  name: "Sophia Lee",
